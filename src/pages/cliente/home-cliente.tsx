...
import { listArgumentsCliente } from "../../constant";
...
export const HomeCliente = () => {
  ...
  const filteredArguments = useMemo(() => {
    ...
    if (!trimmed) return listArgumentsCliente;

    return listArgumentsCliente.filter((item) => {
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <header className="mb-10">
          ...
          <p className="text-slate-600 text-sm sm:text-base max-w-3xl">
            Trova rapidamente risposte su registrazione, accesso, prenotazioni e
            pagamenti.
          </p>
        </header>
        ...
        <div className="w-full sm:w-2/3 lg:w-1/2 mb-8">
          <input
            ...
            placeholder="Cerca tra le FAQ (es. password, pagamento, prenotazione...)"
